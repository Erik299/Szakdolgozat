...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Már 12. 11:36
...
-- Adatbázis: `logopedia`
--
CREATE DATABASE IF NOT EXISTS `logopedia` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `logopedia`;
...
('11111111114', 'Rupp Ardó', 'Szeged', '2018-09-02', 'Boros Berta', 4, 2, 1, NULL, 0x30),
('11111111115', 'Juhász Bende Norbert', 'Szeged', '2018-05-18', 'Bárány Bianka', 5, 3, 2, '2018-01-04', 0x31),
...
('11111111130', 'Bodó-Hanák Adél ', 'Szeged', '2018-05-07', 'Kovács Anett', 20, 2, 1, NULL, 0x30),
...
('11111111155', 'Palatinus Andrea ', 'Szeged', '2018-07-09', 'Lehóczki Zsanett', 45, 2, 1, NULL, 0x30),
...
--
ALTER TABLE `szakemberek`
  MODIFY `ellato_szakemberID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
